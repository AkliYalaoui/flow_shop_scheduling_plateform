...
const baseURL = process.env.REACT_APP_API_URL + "/heuristic-palmer";
  ...
  return (
    <div>
      ...
      <section className="max-w-4xl m-auto">
        {!hideForm && <AlgorithmLauncher loading={loading} error={error} formInputHandler={formInputHandler} startAlgorithm={startPalmer}/>}
        {
          hideForm && <AlgorithmeResult body={body} res={res} title="PALMER" />
        }
      </section>
    </div>
  )
