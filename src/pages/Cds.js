...
const baseURL = process.env.REACT_APP_API_URL + "/heuristic-cds";
  ...
  return (
    <div>
      ...
      <section className="max-w-4xl m-auto">
        {!hideForm && <AlgorithmLauncher loading={loading} error={error} formInputHandler={formInputHandler} startAlgorithm={startCds}/>}
        {
          hideForm && <AlgorithmeResult body={body} res={res} title="CDS" />
        }
      </section>
    </div>
  )
